...
function socials(){
    return(
        ...
        <Image placeholder="blur" src={twitter} alt="twitter" className='w-[30px] h-[30px] lg:w-[45px] lg:h-[45px]'></Image>
            </a>
        </li>
        <li>
            <a href="https://discord.com/invite/RGe5w5EzjC" target={"_blank"} rel="noreferrer">
        <Image placeholder="blur" src={discord} alt="discord" className='w-[30px] h-[30px]  lg:w-[45px] lg:h-[45px]'></Image>
            </a>
        </li>
        <li>
            <a href="https://www.instagram.com/layerrxyz/" target={"_blank"} rel="noreferrer">
        <Image placeholder="blur" src={instagram} alt="instagram" className='w-[30px] h-[30px]  lg:w-[45px] lg:h-[45px]'></Image>
             </a>
       </li>
        </ul>
