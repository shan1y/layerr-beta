  ...
  return (
    <>
      <Head>
        ...
        <link rel="preload" as="image" href="	https://layerr-join-beta.netlify.app/_next/image?u…atic%2Fmedia%2FRectangle.e4533d54.webp&w=828&q=50" />
        <link rel="preload" as="image" href="https://layerr-join-beta.netlify.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FmobileBackground.6aa2f645.webp&w=1920&q=50" />
        <link rel="preload" as="image" href="https://layerr-join-beta.netlify.app/_next/image?u…tic%2Fmedia%2FRectangle.e4533d54.webp&w=1920&q=50"/>
        <link rel="preload" as="image" href="	https://layerr-join-beta.netlify.app/_next/image?u…2Fstatic%2Fmedia%2Fjoin.9b5984df.webp&w=1920&q=50"/>
        <link rel="preload" as="image" href="https://main--layerr-join-beta.netlify.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FGroup-25.889b5474.webp&w=1920&q=50"/>
        <link rel="preload" as="image" href="https://layerr-join-beta.netlify.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flayerrlogo.0a7d0e92.png&w=3840&q=50"/>
      ...
      <div className="hidden max-w-[1280px] m-auto lg:flex main-content left-animation-desktop">
        ...
        <Image quality={50} placeholder="blur" className='h-[200px] z-20 -translate-y-20 m-auto w-auto background-bottom-right lg:hidden'alt="gradient circle" src={circle}></Image>
        <Image quality={50} placeholder="blur" className=" absolute shadow-xl mobile-waffle md:-top-[100px]  h-[600px] md:min-h-[700px] top-0 opacity-50 -translate-x-[50%] lg:hidden  translate-y-24 md:translate-y-8 lg:hidden" src={mobileBackground} alt="waffle for background"/>
        ...
        <div className="absolute circle-shadow  top-[0] md:top-[0%] inset-0 h-[300px] md:h-[500px] top-0  rounded-lg bg-white-shadow opacity-75 lg:hidden"></div>
          <div className='absolute  left-animation center-div flex flex-col justify-center items-center lg:hidden'>
            ...
            <a href="https://twitter.com" className='flex w-full justify-center'><Image quality={50} placeholder="blur" className='top-[400px]  w-[200px]'alt="join beta button" src={join}></Image></a>
      ...
      <div className='hidden z-10 max-w-[1280px] left-animation-desktop m-auto  main-content  relative lg:flex flex min-h-[100vh] px-[2%] items-center'>
        ...
        <a href="https://twitter.com" className='flex w-full '><Image placeholder='blur' quality={50} className='top-[400px]  w-[200px]'alt="join beta button" src={join}></Image></a>
        </div>
